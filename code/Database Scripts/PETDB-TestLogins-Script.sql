...
INSERT INTO `petdatabase`.`login` (`username`, `password`, `authlevel`) VALUES ('lab', 'level123', 1);
INSERT INTO `petdatabase`.`login` (`username`, `password`, `authlevel`) VALUES ('admin', 'super123', 2);
