...
INSERT INTO `tempPETdb`.`errorForm` (`id`, `date`, `time`, `patientFirstName`, `patientSurname`, `patientId`, 
...
INSERT INTO `tempPETdb`.`User` (`id`, `email`, `password`, `authlevel`) 
VALUES (1, 'test@test.com', '12345', 1);

INSERT INTO `tempPETdb`.`User` (`id`, `email`, `password`, `authlevel`) 
VALUES (2, 'frank@test.com', '12345', 1);

INSERT INTO `tempPETdb`.`User` (`id`, `email`, `password`, `authlevel`) 
VALUES (3, 'jules@test.com', 'password', 1);

INSERT INTO `tempPETdb`.`User` (`id`, `email`, `password`, `authlevel`) 
VALUES (4, 'admin@test.com', 'super', 2);
